# 🌿 Portfolio – Chiara Rossetti

Welcome to my professional space. 
Here I collect a curated selection of my university projects, my thesis, and other works that represent my academic and technical journey.
...
Group Project Work for the Finance LAB Course: this project explores how Blockchain and Distributed Ledger Technology can be applied to corporate bond settlement, with a focus on improving secondary market infrastructure. By analysing case studies such as Cassa Depositi e Prestiti and Société Générale, it evaluates how DLT can increase efficiency, transparency, and automation in capital markets.
📄 [Document](./FinanceLAB_REPORT.pdf) and [Presentation](./FinanceLAB_PRESENTATION.pdf)
